...
- [medium] → `work-cards/15-doe-guidance-line.md` — DOE guidance line under the reading; **blocked at copy verification**: the three brainstormed thresholds (100 outdoor / 150 sustained-24h disaster / 200 schools) could not be verified against any reachable official DOE source (7 source attempts logged in the card), and the app displays US AQI while DOE thresholds are on the Malaysian API scale — awaiting the builder's official source, the verified-API-categories fallback, or a drop decision (promoted 2026-09-15 — builder priority 3 of 3)
